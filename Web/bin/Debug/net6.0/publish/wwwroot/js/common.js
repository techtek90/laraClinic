...
---------------------------------------------------*/	
	...
	function ContactMap() {	
		...
		if( jQuery('#map_canvas').length > 0 ){					
			var latlng = new google.maps.LatLng(51.2615195, -0.5883299);
			var settings = {
				zoom: 14,
				center: new google.maps.LatLng(51.2615195, -0.5883299),
			...
			var companyPos = new google.maps.LatLng(51.2615195, -0.5883299);	
