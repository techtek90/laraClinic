			  ...
			  $(window).on('popstate', function() {
				...
				section.load(url+' .cd-main-content > *', function(event){
				  // load new content and replace <main> content with the new one
					...
					gsap.to($(".thumb-page"), { duration: 0, visibility: 'hidden', delay: 0, ease: Power2.easeOut }); 
...
---------------------------------------------------*/	
	...
	function ContactMap() {	
		...
		if( jQuery('#map_canvas').length > 0 ){					
			var latlng = new google.maps.LatLng(51.2345057706910, -0.573879000015875);
			var settings = {
				zoom: 14,
				center: new google.maps.LatLng(51.2345057706910, -0.573879000015875),
			...
			var companyPos = new google.maps.LatLng(51.2345057706910, -0.573879000015875);
			//51.234477, -0.573949
			//51.2344774, -0.5739487
			//51.2615195, -0.5883299
